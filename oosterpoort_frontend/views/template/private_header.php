...
<head>
  ...
  <?php
  if( file_exists(FCPATH.'resources/js/private_pages/'.$page.'.js') && filesize(FCPATH.'resources/js/private_pages/'.$page.'.js') > 0 ) {
  ?>
  <script src="<?php echo base_url(); ?>resources/js/private_pages/<?php echo $page; ?>.js" type="text/javascript"></script>
  <?php
  }
  ?>
  ...
  <?php
  if( file_exists(FCPATH.'resources/css/private_pages/'.$page.'.css') && filesize(FCPATH.'resources/css/private_pages/'.$page.'.css') > 0 ) {
  ?>
  <link href="<?php echo base_url(); ?>resources/css/private_pages/<?php echo $page; ?>.css" rel="stylesheet" type="text/css"></link>
  <?php
  }
  ?>
   <!--<![endif]-->
